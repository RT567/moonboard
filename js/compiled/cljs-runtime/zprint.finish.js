...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__54285_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__54285_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__54285_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__54294){
var vec__54295 = p__54294;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54295,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54295,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__54311,s,color,element,idx){
var map__54312 = p__54311;
var map__54312__$1 = cljs.core.__destructure_map(map__54312);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54312__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54312__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54312__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__54322 = (function (){var or__5045__auto__ = color;
...
var fexpr__54321 = (function (){var G__54324 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__54324) : style_map.call(null,G__54324));
})();
return (fexpr__54321.cljs$core$IFn$_invoke$arity$1 ? fexpr__54321.cljs$core$IFn$_invoke$arity$1(G__54322) : fexpr__54321.call(null,G__54322));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__54334){
var vec__54340 = p__54334;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54340,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54340,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54340,(2),null);
...
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54350,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54350,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54350,(2),null);
...
var G__54812 = cljs.core.next(ssv);
var G__54813 = (this_ssv == null);
var G__54814 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__54815 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__54812;
doing_nil_QMARK_ = G__54813;
last_elide = G__54814;
out = G__54815;
continue;
}
...
var vec__54399 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54399,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54399,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54399,(2),null);
...
var G__54823 = cljs.core.next(remaining_cvec);
var G__54824 = new_idx;
var G__54825 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__54823;
idx = G__54824;
out = G__54825;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__54523,cursor_vec){
var vec__54524 = p__54523;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54524,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54524,(1),null);
var focus_vec = vec__54524;
...
var vec__54530 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54530,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54530,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(color_fn,p__54547){
var vec__54549 = p__54547;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54549,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54549,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__54595,existing_count){
var vec__54598 = p__54595;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54598,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54598,(1),null);
...
return cljs.core.filterv((function (p1__54587_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__54587_SHARP_))));
...
var vec__54633 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54633,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54633,(1),null);
var cvec_element = vec__54633;
if((cvec_element == null)){
var G__54907 = cljs.core.next(cvec_nl);
var G__54908 = (idx + (1));
var G__54909 = start;
var G__54910 = out;
cvec_nl = G__54907;
...
var G__54912 = cljs.core.next(cvec_nl);
var G__54913 = (idx + (1));
var G__54914 = idx;
var G__54915 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__54912;
idx = G__54913;
start = G__54914;
out = G__54915;
...
var G__54916 = cljs.core.next(cvec_nl);
var G__54917 = (idx + (1));
var G__54918 = (idx + (1));
var G__54919 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__54916;
idx = G__54917;
start = G__54918;
out = G__54919;
...
var G__54927 = cljs.core.next(cvec_nl);
var G__54928 = (idx + (1));
var G__54929 = idx;
var G__54930 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__54927;
idx = G__54928;
start = G__54929;
out = G__54930;
...
var G__54931 = cljs.core.next(cvec_nl);
var G__54932 = (idx + (1));
var G__54933 = start;
var G__54934 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__54931;
idx = G__54932;
start = G__54933;
out = G__54934;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__54656_SHARP_,p2__54655_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__54655_SHARP_)){
return cljs.core.reduced(p1__54656_SHARP_);
} else {
return (p1__54656_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__54665,p__54666){
var vec__54667 = p__54665;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54667,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54667,(1),null);
var vec__54670 = p__54666;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54670,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54670,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__54735,cvec,focus_vec){
var map__54740 = p__54735;
var map__54740__$1 = cljs.core.__destructure_map(map__54740);
var options = map__54740__$1;
var map__54742 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54740__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__54742__$1 = cljs.core.__destructure_map(map__54742);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54742__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54742__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54742__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54720_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__54720_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
