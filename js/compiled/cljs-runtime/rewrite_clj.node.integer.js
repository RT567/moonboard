...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k55951,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k55951,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__55969){
var vec__55970 = p__55969;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55970,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55970,(1),null);
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__55950){
var self__ = this;
var G__55950__$1 = this;
return (new cljs.core.RecordIter((0),G__55950__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"base","base",185279322)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this55952,other55953){
var self__ = this;
var this55952__$1 = this;
return (((!((other55953 == null)))) && ((((this55952__$1.constructor === other55953.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this55952__$1.value,other55953.value)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this55952__$1.base,other55953.base)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this55952__$1.__extmap,other55953.__extmap)))))))));
}));
...
var abs_value = (function (){var G__56006 = self__.value;
if((self__.value < (0))){
return (- G__56006);
} else {
return G__56006;
...
var prefix = (function (){var G__56009 = cljs.core.long$(self__.base);
switch (G__56009) {
case (8):
return "0";
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k55951){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k55951);

}
}));

(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__55950){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__56012 = cljs.core.keyword_identical_QMARK_;
var expr__56013 = k__5352__auto__;
if(cljs.core.truth_((pred__56012.cljs$core$IFn$_invoke$arity$2 ? pred__56012.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217),expr__56013) : pred__56012.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__56013)))){
return (new rewrite_clj.node.integer.IntNode(G__55950,self__.base,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56012.cljs$core$IFn$_invoke$arity$2 ? pred__56012.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"base","base",185279322),expr__56013) : pred__56012.call(null,new cljs.core.Keyword(null,"base","base",185279322),expr__56013)))){
return (new rewrite_clj.node.integer.IntNode(self__.value,G__55950,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.integer.IntNode(self__.value,self__.base,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__55950),null));
}
}
}));
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__55950){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.integer.IntNode(self__.value,self__.base,G__55950,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.integer.map__GT_IntNode = (function rewrite_clj$node$integer$map__GT_IntNode(G__55957){
var extmap__5385__auto__ = (function (){var G__56032 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__55957,new cljs.core.Keyword(null,"value","value",305978217),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"base","base",185279322)], 0));
if(cljs.core.record_QMARK_(G__55957)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__56032);
} else {
return G__56032;
}
})();
return (new rewrite_clj.node.integer.IntNode(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__55957),new cljs.core.Keyword(null,"base","base",185279322).cljs$core$IFn$_invoke$arity$1(G__55957),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
