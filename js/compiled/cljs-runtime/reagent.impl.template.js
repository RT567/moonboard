...
var G__42072 = o;
reagent.impl.template.goog$module$goog$object.set(G__42072,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__42483__i < G__42483__a.length) {G__42483__a[G__42483__i] = arguments[G__42483__i + 0]; ++G__42483__i;}
  args = new cljs.core.IndexedSeq(G__42483__a,0,null);
} 
return G__42480__delegate.call(this,args);};
G__42480.cljs$lang$maxFixedArity = 0;
G__42480.cljs$lang$applyTo = (function (arglist__42494){
var args = cljs.core.seq(arglist__42494);
...
var G__42087 = o;
reagent.impl.template.goog$module$goog$object.set(G__42087,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__42536__i < G__42536__a.length) {G__42536__a[G__42536__i] = arguments[G__42536__i + 0]; ++G__42536__i;}
  args = new cljs.core.IndexedSeq(G__42536__a,0,null);
} 
return G__42534__delegate.call(this,args);};
G__42534.cljs$lang$maxFixedArity = 0;
G__42534.cljs$lang$applyTo = (function (arglist__42538){
var args = cljs.core.seq(arglist__42538);
...
var G__42098 = props;
var G__42098__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__42098,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__42098);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__42098__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__42102 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__42102,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__42102;
}
})(),id_class);
...
var G__42116 = (cljs.core.count(argv) - first_child);
switch (G__42116) {
case (0):
...
var vec__42158 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42158,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42158,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42158,(2),null);
...
var temp__5808__auto___42591 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___42591 == null)){
} else {
var key_42594 = temp__5808__auto___42591;
(jsprops.key = key_42594);
}
...
var temp__5808__auto___42596 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___42596 == null)){
} else {
var key_42598 = temp__5808__auto___42596;
(jsprops.key = key_42598);
}
...
var temp__5808__auto___42610 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___42610 == null)){
} else {
var key_42611 = temp__5808__auto___42610;
(jsprops.key = key_42611);
}
...
var temp__5808__auto___42629 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___42629 == null)){
} else {
var key_42630 = temp__5808__auto___42629;
(jsprops.key = key_42630);
}
...
var temp__5808__auto___42632 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___42632 == null)){
} else {
var key_42633 = temp__5808__auto___42632;
(jsprops.key = key_42633);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42295_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__42295_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__42346 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42346,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42346,(1),null);
...
break;
default:
var G__42643 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__42644 = compiler;
v = G__42643;
compiler = G__42644;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template42382 = (function (opts,id,fn_to_element,parse_fn,meta42383){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template42382.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_42384,meta42383__$1){
var self__ = this;
var _42384__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template42382(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta42383__$1));
}));

(reagent.impl.template.t_reagent$impl$template42382.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_42384){
var self__ = this;
var _42384__$1 = this;
return self__.meta42383;
}));

(reagent.impl.template.t_reagent$impl$template42382.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template42382.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template42382.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template42382.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template42382.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template42382.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta42383","meta42383",-1560851786,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template42382.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template42382.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template42382");

(reagent.impl.template.t_reagent$impl$template42382.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template42382");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template42382.
 */
reagent.impl.template.__GT_t_reagent$impl$template42382 = (function reagent$impl$template$__GT_t_reagent$impl$template42382(opts,id,fn_to_element,parse_fn,meta42383){
return (new reagent.impl.template.t_reagent$impl$template42382(opts,id,fn_to_element,parse_fn,meta42383));
});
...
return (new reagent.impl.template.t_reagent$impl$template42382(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
