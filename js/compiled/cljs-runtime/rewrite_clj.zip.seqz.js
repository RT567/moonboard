...
var G__59194 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(zloc_n0) : f.call(null,zloc_n0));
var G__59194__$1 = (((G__59194 == null))?null:cljs.core.iterate((function (loc){
...
var G__59194__$2 = (((G__59194__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__59194__$1));
var G__59194__$3 = (((G__59194__$2 == null))?null:cljs.core.last(G__59194__$2));
if((G__59194__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__59194__$3);
}
} else {
return zloc;
}
...
var G__59255 = rewrite_clj.zip.move.right(new_zloc_map_value);
var G__59256 = rewrite_clj.zip.move.up(new_zloc_map_value);
loc = G__59255;
parent = G__59256;
continue;
} else {
var G__59257 = rewrite_clj.zip.move.right(zloc_map_value);
var G__59258 = parent;
loc = G__59257;
parent = G__59258;
continue;
...
var G__59265 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(zloc_map_key));
var G__59266 = rewrite_clj.zip.move.up(zloc_map_key);
loc = G__59265;
parent = G__59266;
continue;
} else {
var G__59267 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__59268 = parent;
loc = G__59267;
parent = G__59268;
continue;
...
var G__59234 = zloc;
var G__59234__$1 = (((G__59234 == null))?null:rewrite_clj.zip.move.down(G__59234));
var G__59234__$2 = (((G__59234__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__59234__$1,k));
if((G__59234__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__59234__$2);
}
} else {
if(rewrite_clj.zip.seqz.namespaced_map_QMARK_(zloc)){
var G__59236 = zloc;
var G__59236__$1 = (((G__59236 == null))?null:rewrite_clj.zip.move.down(G__59236));
var G__59236__$2 = (((G__59236__$1 == null))?null:rewrite_clj.zip.move.rightmost(G__59236__$1));
var G__59236__$3 = (((G__59236__$2 == null))?null:rewrite_clj.zip.move.down(G__59236__$2));
var G__59236__$4 = (((G__59236__$3 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__59236__$3,k));
if((G__59236__$4 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__59236__$4);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__59237 = rewrite_clj.zip.move.down(zloc);
var G__59237__$1 = (((G__59237 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__59237));
if((G__59237__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__59237__$1);
}
})(),k);
