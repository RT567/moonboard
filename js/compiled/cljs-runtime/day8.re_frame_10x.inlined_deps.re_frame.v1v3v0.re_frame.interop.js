...
return [(function (){var pred__34650 = cljs.core.instance_QMARK_;
var expr__34651 = reactive_val;
if(cljs.core.truth_((pred__34650.cljs$core$IFn$_invoke$arity$2 ? pred__34650.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.RAtom,expr__34651) : pred__34650.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.RAtom,expr__34651)))){
return "ra";
} else {
if(cljs.core.truth_((pred__34650.cljs$core$IFn$_invoke$arity$2 ? pred__34650.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.RCursor,expr__34651) : pred__34650.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.RCursor,expr__34651)))){
return "rc";
} else {
if(cljs.core.truth_((pred__34650.cljs$core$IFn$_invoke$arity$2 ? pred__34650.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.Reaction,expr__34651) : pred__34650.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.Reaction,expr__34651)))){
return "rx";
} else {
if(cljs.core.truth_((pred__34650.cljs$core$IFn$_invoke$arity$2 ? pred__34650.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.Track,expr__34651) : pred__34650.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.Track,expr__34651)))){
return "tr";
} else {
return "other";
}
