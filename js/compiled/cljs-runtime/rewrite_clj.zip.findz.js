...
var len__5769__auto___59174 = arguments.length;
var i__5770__auto___59175 = (0);
while(true){
if((i__5770__auto___59175 < len__5769__auto___59174)){
args__5775__auto__.push((arguments[i__5770__auto___59175]));

var G__59176 = (i__5770__auto___59175 + (1));
i__5770__auto___59175 = G__59176;
continue;
} else {
}
break;
...
(rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__59058){
var vec__59059 = p__59058;
var additional = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59059,(0),null);
...
return (function (p1__59046_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__59046_SHARP_),t);
});
}
}));
...
/** @this {Function} */
(rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq59047){
var G__59048 = cljs.core.first(seq59047);
var seq59047__$1 = cljs.core.next(seq59047);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__59048,seq59047__$1);
}));

rewrite_clj.zip.findz.position_in_range_QMARK_ = (function rewrite_clj$zip$findz$position_in_range_QMARK_(zloc,pos){
var vec__59065 = ((cljs.core.map_QMARK_(pos))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"row","row",-570139521).cljs$core$IFn$_invoke$arity$1(pos),new cljs.core.Keyword(null,"col","col",-1959363084).cljs$core$IFn$_invoke$arity$1(pos)], null):pos);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59065,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59065,(1),null);
if((((r <= (0))) || ((c <= (0))))){
...
var vec__59069 = rewrite_clj.custom_zipper.core.position_span(zloc);
var vec__59072 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59069,(0),null);
var zstart_row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59072,(0),null);
var zstart_col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59072,(1),null);
var vec__59075 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59069,(1),null);
var zend_row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59075,(0),null);
var zend_col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59075,(1),null);
...
return cljs.core.last(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__59100_SHARP_){
var and__5043__auto__ = (p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__59100_SHARP_) : p_QMARK_.call(null,p1__59100_SHARP_));
if(cljs.core.truth_(and__5043__auto__)){
return rewrite_clj.zip.findz.position_in_range_QMARK_(p1__59100_SHARP_,pos);
} else {
return and__5043__auto__;
}
...
var G__59126 = zloc;
var G__59126__$1 = (((G__59126 == null))?null:(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__59126) : f.call(null,G__59126)));
if((G__59126__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(G__59126__$1,f,p_QMARK_);
}
}));
...
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(zloc,f,(function (p1__59131_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__59131_SHARP_),t);
}));
}));
...
return rewrite_clj.zip.findz.find_last_by_pos.cljs$core$IFn$_invoke$arity$3(zloc,pos,(function (p1__59147_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__59147_SHARP_),t);
}));
});
/**
...
var p_QMARK_ = ((cljs.core.set_QMARK_(v))?cljs.core.comp.cljs$core$IFn$_invoke$arity$2(v,rewrite_clj.zip.base.sexpr):(function (p1__59160_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.sexpr(p1__59160_SHARP_),v);
}));
