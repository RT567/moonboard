...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_38393 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_38393(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_38401 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_38401(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_38403 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_38403(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_38407 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_38407(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_38410 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_38410(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_38411 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_38411(reader);
}
});
...
var G__38500 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__38501 = s.append(c);
c = G__38500;
s = G__38501;
continue;
}
