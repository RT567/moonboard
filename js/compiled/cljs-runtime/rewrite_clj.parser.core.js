...
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__57509 = cljs.core.get_global_hierarchy;
return (fexpr__57509.cljs$core$IFn$_invoke$arity$0 ? fexpr__57509.cljs$core$IFn$_invoke$arity$0() : fexpr__57509.call(null));
})());
...
return rewrite_clj.reader.read_repeatedly(reader,(function (p1__57519_SHARP_){
var _STAR_delimiter_STAR__orig_val__57521 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
var _STAR_delimiter_STAR__temp_val__57522 = delimiter;
(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__temp_val__57522);

try{return rewrite_clj.parser.core.parse_next(p1__57519_SHARP_);
}finally {(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__orig_val__57521);
}}));
});
rewrite_clj.parser.core.parse_printables = (function rewrite_clj$parser$core$parse_printables(var_args){
var args__5775__auto__ = [];
var len__5769__auto___57572 = arguments.length;
var i__5770__auto___57573 = (0);
while(true){
if((i__5770__auto___57573 < len__5769__auto___57572)){
args__5775__auto__.push((arguments[i__5770__auto___57573]));

var G__57574 = (i__5770__auto___57573 + (1));
i__5770__auto___57573 = G__57574;
continue;
} else {
}
break;
...
(rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__57538){
var vec__57539 = p__57538;
var ignore_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57539,(0),null);
...
/** @this {Function} */
(rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq57527){
...
var G__57530 = cljs.core.first(seq57527__$2);
var seq57527__$3 = cljs.core.next(seq57527__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57528,G__57529,G__57530,seq57527__$3);
}));
...
var G__57554 = rewrite_clj.reader.peek(reader);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57554)){
return rewrite_clj.reader.throw_reader(reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("!",G__57554)){
...
return cljs.core.cons((function (){var G__57559 = rewrite_clj.reader.peek(reader);
switch (G__57559) {
case "(":
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("_",G__57554)){
