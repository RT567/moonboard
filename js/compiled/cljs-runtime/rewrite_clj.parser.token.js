...
var len__5769__auto___57408 = arguments.length;
var i__5770__auto___57409 = (0);
while(true){
if((i__5770__auto___57409 < len__5769__auto___57408)){
args__5775__auto__.push((arguments[i__5770__auto___57409]));

var G__57411 = (i__5770__auto___57409 + (1));
i__5770__auto___57409 = G__57411;
continue;
} else {
}
break;
...
(rewrite_clj.parser.token.read_to_boundary.cljs$core$IFn$_invoke$arity$variadic = (function (reader,p__57398){
var vec__57399 = p__57398;
var allowed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57399,(0),null);
var allowed_QMARK_ = cljs.core.set(allowed);
return rewrite_clj.reader.read_until(reader,(function (p1__57395_SHARP_){
var and__5043__auto__ = cljs.core.not((allowed_QMARK_.cljs$core$IFn$_invoke$arity$1 ? allowed_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__57395_SHARP_) : allowed_QMARK_.call(null,p1__57395_SHARP_)));
if(and__5043__auto__){
return rewrite_clj.reader.whitespace_or_boundary_QMARK_(p1__57395_SHARP_);
} else {
...
/** @this {Function} */
(rewrite_clj.parser.token.read_to_boundary.cljs$lang$applyTo = (function (seq57396){
var G__57397 = cljs.core.first(seq57396);
var seq57396__$1 = cljs.core.next(seq57396);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57397,seq57396__$1);
}));
