...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__41534 = c;
var G__41534__$1 = (((G__41534 == null))?null:G__41534.prototype);
if((G__41534__$1 == null)){
return null;
} else {
return G__41534__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__41541 = c;
var G__41541__$1 = (((G__41541 == null))?null:G__41541.prototype);
if((G__41541__$1 == null)){
return null;
} else {
return G__41541__$1.render;
}
})() == null)))));
});
...
var G__41867__i = 0, G__41867__a = new Array(arguments.length -  0);
while (G__41867__i < G__41867__a.length) {G__41867__a[G__41867__i] = arguments[G__41867__i + 0]; ++G__41867__i;}
  args = new cljs.core.IndexedSeq(G__41867__a,0,null);
} 
return G__41862__delegate.call(this,args);};
G__41862.cljs$lang$maxFixedArity = 0;
G__41862.cljs$lang$applyTo = (function (arglist__41869){
var args = cljs.core.seq(arglist__41869);
...
var or__5045__auto__ = (function (){var G__41577 = c;
var G__41577__$1 = (((G__41577 == null))?null:G__41577.constructor);
if((G__41577__$1 == null)){
return null;
} else {
return G__41577__$1.displayName;
}
})();
...
var G__41578 = c;
var G__41578__$1 = (((G__41578 == null))?null:G__41578.constructor);
if((G__41578__$1 == null)){
return null;
} else {
return G__41578__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__41596 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__41597 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__41597);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__41596);
}});
...
var c = this;
var G__41643_41922 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__41643_41922 == null)){
} else {
reagent.ratom.dispose_BANG_(G__41643_41922);
}
...
var renders_41933 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_41934 = cljs.core.first(cljs.core.vals(renders_41933));
...
if((cljs.core.count(renders_41933) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_41933))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_41934)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_41934], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__41680 = o;
reagent.impl.component.goog$module$goog$object.set(G__41680,cljs.core.name(k),v);
...
G__41997.cljs$lang$applyTo = (function (arglist__42001){
...
var _STAR_current_component_STAR__orig_val__41767 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__41768 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__41768);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__41767);
}});
...
var vec__41785 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41785,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41785,(1),null);
...
var G__41794 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__41794 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__41794);
}
});
}),[]);
