...
var periods__$1 = cljs.core.vec((function (){var G__80197 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__80195_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__80195_SHARP_,(0),(3));
}),G__80197);
} else {
return G__80197;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__80251){
var vec__80252 = p__80251;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80252,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80252,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__80256 = pattern;
switch (G__80256) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__80256)].join('')));
...
var G__80272 = key;
var G__80272__$1 = (((G__80272 instanceof cljs.core.Keyword))?G__80272.fqn:null);
switch (G__80272__$1) {
case "millis":
return (function (p1__80264_SHARP_){
return p1__80264_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__80265_SHARP_){
return p1__80265_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__80266_SHARP_){
return p1__80266_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__80267_SHARP_){
return p1__80267_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__80268_SHARP_){
return p1__80268_SHARP_.getHours();
});

break;
case "day":
return (function (p1__80269_SHARP_){
return p1__80269_SHARP_.getDate();
});

break;
case "month":
return (function (p1__80270_SHARP_){
return p1__80270_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__80271_SHARP_){
return p1__80271_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__80272__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__80280){
var vec__80281 = p__80280;
var seq__80282 = cljs.core.seq(vec__80281);
var first__80283 = cljs.core.first(seq__80282);
var seq__80282__$1 = cljs.core.next(seq__80282);
var key = first__80283;
var args = seq__80282__$1;
var G__80284 = key;
var G__80284__$1 = (((G__80284 instanceof cljs.core.Keyword))?G__80284.fqn:null);
switch (G__80284__$1) {
case "millis":
...
break;
case "ordinal-suffix":
var vec__80289 = (function (){var G__80292 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__80292) : syntax_list.call(null,G__80292));
})();
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80289,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__80284__$1)].join('')));
...
var d = value;
var G__80313 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__80315 = G__80313;
var seq__80316 = cljs.core.seq(vec__80315);
var first__80317 = cljs.core.first(seq__80316);
var seq__80316__$1 = cljs.core.next(seq__80316);
var unparser = first__80317;
var more = seq__80316__$1;
var s = "";
var d__$1 = d;
var G__80313__$1 = G__80313;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__80328 = G__80313__$1;
...
var unparser__$1 = first__80330;
var more__$1 = seq__80329__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__80332 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80332,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80332,(1),null);
var G__80477 = d__$3;
var G__80478 = more__$1;
var G__80479 = s__$3;
d__$1 = G__80477;
G__80313__$1 = G__80478;
s__$1 = G__80479;
continue;
}
break;
