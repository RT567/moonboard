...
var len__5769__auto___26916 = arguments.length;
var i__5770__auto___26917 = (0);
while(true){
if((i__5770__auto___26917 < len__5769__auto___26916)){
args__5775__auto__.push((arguments[i__5770__auto___26917]));

var G__26918 = (i__5770__auto___26917 + (1));
i__5770__auto___26917 = G__26918;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq26626){
var G__26627 = cljs.core.first(seq26626);
var seq26626__$1 = cljs.core.next(seq26626);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26627,seq26626__$1);
}));
...
return cljs.core.some((function (p1__26638_SHARP_){
return (p1__26638_SHARP_ === object);
}),history__$1);
});
...
var args__5775__auto__ = [];
var len__5769__auto___26922 = arguments.length;
var i__5770__auto___26923 = (0);
while(true){
if((i__5770__auto___26923 < len__5769__auto___26922)){
args__5775__auto__.push((arguments[i__5770__auto___26923]));

var G__26924 = (i__5770__auto___26923 + (1));
i__5770__auto___26923 = G__26924;
continue;
} else {
}
break;
...
(devtools.formatters.state.present_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (v,p__26650){
var vec__26651 = p__26650;
var starting_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26651,(0),null);
if(typeof v === 'string'){
return v;
} else {
...
/** @this {Function} */
(devtools.formatters.state.present_path_segment.cljs$lang$applyTo = (function (seq26645){
var G__26646 = cljs.core.first(seq26645);
var seq26645__$1 = cljs.core.next(seq26645);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26646,seq26645__$1);
}));

devtools.formatters.state.seek_path_segment = (function devtools$formatters$state$seek_path_segment(var_args){
var args__5775__auto__ = [];
var len__5769__auto___26925 = arguments.length;
var i__5770__auto___26926 = (0);
while(true){
if((i__5770__auto___26926 < len__5769__auto___26925)){
args__5775__auto__.push((arguments[i__5770__auto___26926]));

var G__26927 = (i__5770__auto___26926 + (1));
i__5770__auto___26926 = G__26927;
continue;
} else {
}
break;
...
(devtools.formatters.state.seek_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (coll,val,p__26814){
var vec__26815 = p__26814;
var seq_SINGLEQUOTE_d_map_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26815,(0),null);
...
var _STAR_ = (function (p__26825){
var vec__26826 = p__26825;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26826,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26826,(1),null);
...
/** @this {Function} */
(devtools.formatters.state.seek_path_segment.cljs$lang$applyTo = (function (seq26664){
var G__26665 = cljs.core.first(seq26664);
var seq26664__$1 = cljs.core.next(seq26664);
var G__26666 = cljs.core.first(seq26664__$1);
var seq26664__$2 = cljs.core.next(seq26664__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26665,G__26666,seq26664__$2);
}));
