...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__81459_SHARP_,p2__81460_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__81459_SHARP_,p2__81460_SHARP_,reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false));
}),tour_map,tour_spec);
});
/**
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__5523__auto__ = (function re_com$tour$initialise_tour_$_iter__81461(s__81462){
return (new cljs.core.LazySeq(null,(function (){
var s__81462__$1 = s__81462;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__81462__$1);
if(temp__5804__auto__){
var s__81462__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__81462__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__81462__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__81464 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__81463 = (0);
while(true){
if((i__81463 < size__5522__auto__)){
var step = cljs.core._nth(c__5521__auto__,i__81463);
cljs.core.chunk_append(b__81464,cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false));

var G__81500 = (i__81463 + (1));
i__81463 = G__81500;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__81464),re_com$tour$initialise_tour_$_iter__81461(cljs.core.chunk_rest(s__81462__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__81464),null);
}
} else {
var step = cljs.core.first(s__81462__$2);
return cljs.core.cons(cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false),re_com$tour$initialise_tour_$_iter__81461(cljs.core.rest(s__81462__$2)));
}
} else {
return null;
}
...
return cljs.core.reset_BANG_((function (){var fexpr__81469 = cljs.core.first(new cljs.core.Keyword(null,"steps","steps",-128433302).cljs$core$IFn$_invoke$arity$1(tour));
return (fexpr__81469.cljs$core$IFn$_invoke$arity$1 ? fexpr__81469.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__81469.call(null,tour));
})(),true);
});
/**
...
cljs.core.reset_BANG_((function (){var fexpr__81472 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__81472.cljs$core$IFn$_invoke$arity$1 ? fexpr__81472.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__81472.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__81473 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__81473.cljs$core$IFn$_invoke$arity$1 ? fexpr__81473.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__81473.call(null,tour));
})(),true);
} else {
return null;
}
...
cljs.core.reset_BANG_((function (){var fexpr__81479 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__81479.cljs$core$IFn$_invoke$arity$1 ? fexpr__81479.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__81479.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__81480 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__81480.cljs$core$IFn$_invoke$arity$1 ? fexpr__81480.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__81480.call(null,tour));
})(),true);
} else {
return null;
}
