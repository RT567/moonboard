...
var comma_57551 = rewrite_clj.node.whitespace.whitespace_nodes(", ");
var space_57552 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.drop_last.cljs$core$IFn$_invoke$arity$2(cljs.core.count(comma_57551),cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__57446){
var vec__57449 = p__57446;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57449,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57449,(1),null);
return cljs.core.list_STAR_.cljs$core$IFn$_invoke$arity$4(rewrite_clj.node.protocols.coerce(k),space_57552,rewrite_clj.node.protocols.coerce(v),comma_57551);
...
return rewrite_clj.node.coercer.node_with_meta((function (){var G__57516 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
