...
var sym_seq = (function (){var iter__5523__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__55625(s__55626){
return (new cljs.core.LazySeq(null,(function (){
var s__55626__$1 = s__55626;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__55626__$1);
if(temp__5804__auto__){
var s__55626__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__55626__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__55626__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__55628 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__55627 = (0);
while(true){
if((i__55627 < size__5522__auto__)){
var i = cljs.core._nth(c__5521__auto__,i__55627);
...
cljs.core.chunk_append(b__55628,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__55719 = (i__55627 + (1));
i__55627 = G__55719;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55628),rewrite_clj$node$fn$fn_walk_$_iter__55625(cljs.core.chunk_rest(s__55626__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55628),null);
}
} else {
var i = cljs.core.first(s__55626__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__55625(cljs.core.rest(s__55626__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__55622_SHARP_){
var or__5045__auto__ = rewrite_clj.node.fn.arg_symbol__GT_gensym(sym_seq,vararg_QMARK_,max_fixed_arg_ndx,p1__55622_SHARP_);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return p1__55622_SHARP_;
}
}),form);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k55640,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k55640,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__55658){
var vec__55660 = p__55658;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55660,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55660,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__55639){
var self__ = this;
var G__55639__$1 = this;
return (new cljs.core.RecordIter((0),G__55639__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this55641,other55642){
var self__ = this;
var this55641__$1 = this;
return (((!((other55642 == null)))) && ((((this55641__$1.constructor === other55642.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this55641__$1.children,other55642.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this55641__$1.__extmap,other55642.__extmap)))))));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k55640){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k55640);

}
}));

(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__55639){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__55691 = cljs.core.keyword_identical_QMARK_;
var expr__55692 = k__5352__auto__;
if(cljs.core.truth_((pred__55691.cljs$core$IFn$_invoke$arity$2 ? pred__55691.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__55692) : pred__55691.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__55692)))){
return (new rewrite_clj.node.fn.FnNode(G__55639,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__55639),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__55639){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__55639,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__55645){
var extmap__5385__auto__ = (function (){var G__55710 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__55645,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__55645)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__55710);
} else {
return G__55710;
}
})();
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__55645),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
