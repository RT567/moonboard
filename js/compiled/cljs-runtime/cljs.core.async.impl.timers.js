...
var i_73794 = (0);
while(true){
if((i_73794 < arr.length)){
(arr[i_73794] = null);

var G__73796 = (i_73794 + (1));
i_73794 = G__73796;
continue;
} else {
}
...
var i_73805 = (self__.level + (1));
while(true){
if((i_73805 <= (new_level + (1)))){
(update[i_73805] = self__.header);

var G__73806 = (i_73805 + (1));
i_73805 = G__73806;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_73807 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_73807[i]));
} else {
x__$2.forward.push((((i < links_73807.length))?(links_73807[i]):null));
}

if((i < links_73807.length)){
(links_73807[i] = x__$2);
} else {
links_73807.push(x__$2);
}
...
var i_73810 = (0);
while(true){
if((i_73810 <= self__.level)){
var links_73812 = (update[i_73810]).forward;
if((x__$1 === (((i_73810 < links_73812.length))?(links_73812[i_73810]):null))){
(links_73812[i_73810] = (x__$1.forward[i_73810]));

var G__73813 = (i_73810 + (1));
i_73810 = G__73813;
continue;
} else {
var G__73814 = (i_73810 + (1));
i_73810 = G__73814;
continue;
}
} else {
...
var G__73817 = nx;
var G__73818 = (level__$1 - (1));
x = G__73817;
level__$1 = G__73818;
continue;
} else {
var G__73819 = x;
var G__73820 = (level__$1 - (1));
x = G__73819;
level__$1 = G__73820;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__73823 = nx;
var G__73824 = (level__$1 - (1));
x = G__73823;
level__$1 = G__73824;
continue;
} else {
var G__73825 = x;
var G__73826 = (level__$1 - (1));
x = G__73825;
level__$1 = G__73826;
continue;
}
