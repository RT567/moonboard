...
if((c === "\n")){
var G__57170 = escape_QMARK_;
var G__57171 = rewrite_clj.parser.impl.flush_into(lines,buf);
escape_QMARK_ = G__57170;
lines = G__57171;
continue;
} else {
buf.append(c);

var G__57176 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__57177 = lines;
escape_QMARK_ = G__57176;
lines = G__57177;
continue;
