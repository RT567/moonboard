...
var G__62614 = rewrite_clj.zip.next(n);
loc = G__62614;
continue;
} else {
var G__62615 = rewrite_clj.zip.next(loc);
loc = G__62615;
continue;
}
} else {
var G__62616 = rewrite_clj.zip.next(loc);
loc = G__62616;
continue;
}
}
...
return rewrite_clj.zip.replace(zloc,rewrite_clj.zip.root(zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__62589 = zloc;
var G__62589__$1 = (((G__62589 == null))?null:rewrite_clj.zip.node(G__62589));
if((G__62589__$1 == null)){
return null;
} else {
return rewrite_clj.zip.of_node_STAR_.cljs$core$IFn$_invoke$arity$1(G__62589__$1);
}
})())));
});
/**
...
var G__62617 = rewrite_clj.zip.down(nloc);
nloc = G__62617;
continue;
}
break;
...
var G__62618 = rewrite_clj.zip.right(nloc);
var G__62619 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__62618;
out = G__62619;
continue;
} else {
...
var G__62625 = rewrite_clj.zip.right(replaced_loc);
var G__62626 = cljs.core.next(new_loc);
var G__62627 = replaced_loc;
nloc = G__62625;
new_loc = G__62626;
last_loc = G__62627;
continue;
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__62607_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.tag(p1__62607_SHARP_),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.sexpr(p1__62607_SHARP_),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
