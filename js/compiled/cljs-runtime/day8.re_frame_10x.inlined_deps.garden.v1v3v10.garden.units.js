 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.units.convert = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$convert(p__40760,right){
var map__40761 = p__40760;
var map__40761__$1 = cljs.core.__destructure_map(map__40761);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40761__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40761__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__40770 = temp__5804__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40770,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40770,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40770,(2),null);
...
var map__40777 = u(x);
var map__40777__$1 = cljs.core.__destructure_map(map__40777);
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40777__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__40778 = u(y);
var map__40778__$1 = cljs.core.__destructure_map(map__40778);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40778__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__40890__delegate = function (x,y,more){
...
var G__40890 = function (x,y,var_args){
var more = null;
...
while (G__40892__i < G__40892__a.length) {G__40892__a[G__40892__i] = arguments[G__40892__i + 2]; ++G__40892__i;}
  more = new cljs.core.IndexedSeq(G__40892__a,0,null);
} 
return G__40890__delegate.call(this,x,y,more);};
G__40890.cljs$lang$maxFixedArity = 2;
G__40890.cljs$lang$applyTo = (function (arglist__40893){
var x = cljs.core.first(arglist__40893);
arglist__40893 = cljs.core.next(arglist__40893);
var y = cljs.core.first(arglist__40893);
var more = cljs.core.rest(arglist__40893);
return G__40890__delegate(x,y,more);
});
...
var G__40894 = null;
if (arguments.length > 2) {
var G__40895__i = 0, G__40895__a = new Array(arguments.length -  2);
while (G__40895__i < G__40895__a.length) {G__40895__a[G__40895__i] = arguments[G__40895__i + 2]; ++G__40895__i;}
G__40894 = new cljs.core.IndexedSeq(G__40895__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__40894);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40781__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__40782 = u(y);
var map__40782__$1 = cljs.core.__destructure_map(map__40782);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40782__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3 = (function() { 
var G__40896__delegate = function (x,y,more){
...
var G__40896 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__40898__i = 0, G__40898__a = new Array(arguments.length -  2);
while (G__40898__i < G__40898__a.length) {G__40898__a[G__40898__i] = arguments[G__40898__i + 2]; ++G__40898__i;}
  more = new cljs.core.IndexedSeq(G__40898__a,0,null);
} 
return G__40896__delegate.call(this,x,y,more);};
G__40896.cljs$lang$maxFixedArity = 2;
G__40896.cljs$lang$applyTo = (function (arglist__40899){
var x = cljs.core.first(arglist__40899);
arglist__40899 = cljs.core.next(arglist__40899);
var y = cljs.core.first(arglist__40899);
var more = cljs.core.rest(arglist__40899);
return G__40896__delegate(x,y,more);
});
...
G__40900 = new cljs.core.IndexedSeq(G__40901__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__40900);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var G__40905__delegate = function (x,y,more){
...
var G__40905 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__40907__i = 0, G__40907__a = new Array(arguments.length -  2);
while (G__40907__i < G__40907__a.length) {G__40907__a[G__40907__i] = arguments[G__40907__i + 2]; ++G__40907__i;}
  more = new cljs.core.IndexedSeq(G__40907__a,0,null);
} 
return G__40905__delegate.call(this,x,y,more);};
G__40905.cljs$lang$maxFixedArity = 2;
G__40905.cljs$lang$applyTo = (function (arglist__40908){
var x = cljs.core.first(arglist__40908);
arglist__40908 = cljs.core.next(arglist__40908);
var y = cljs.core.first(arglist__40908);
var more = cljs.core.rest(arglist__40908);
return G__40905__delegate(x,y,more);
});
...
var G__40909 = null;
if (arguments.length > 2) {
var G__40910__i = 0, G__40910__a = new Array(arguments.length -  2);
while (G__40910__i < G__40910__a.length) {G__40910__a[G__40910__i] = arguments[G__40910__i + 2]; ++G__40910__i;}
G__40909 = new cljs.core.IndexedSeq(G__40910__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__40909);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40790__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__40791 = u(y);
var map__40791__$1 = cljs.core.__destructure_map(map__40791);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40791__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3 = (function() { 
var G__40913__delegate = function (x,y,more){
...
var G__40913 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__40914__i = 0, G__40914__a = new Array(arguments.length -  2);
while (G__40914__i < G__40914__a.length) {G__40914__a[G__40914__i] = arguments[G__40914__i + 2]; ++G__40914__i;}
  more = new cljs.core.IndexedSeq(G__40914__a,0,null);
} 
return G__40913__delegate.call(this,x,y,more);};
G__40913.cljs$lang$maxFixedArity = 2;
G__40913.cljs$lang$applyTo = (function (arglist__40915){
var x = cljs.core.first(arglist__40915);
arglist__40915 = cljs.core.next(arglist__40915);
var y = cljs.core.first(arglist__40915);
var more = cljs.core.rest(arglist__40915);
return G__40913__delegate(x,y,more);
});
G__40913.cljs$core$IFn$_invoke$arity$variadic = G__40913__delegate;
return G__40913;
})()
;
...
var G__40916 = null;
if (arguments.length > 2) {
var G__40917__i = 0, G__40917__a = new Array(arguments.length -  2);
while (G__40917__i < G__40917__a.length) {G__40917__a[G__40917__i] = arguments[G__40917__i + 2]; ++G__40917__i;}
G__40916 = new cljs.core.IndexedSeq(G__40917__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__40916);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
