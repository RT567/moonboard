...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k57192,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57192,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__57217){
var vec__57221 = p__57217;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57221,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57221,(1),null);
...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57195,other57196){
var self__ = this;
var this57195__$1 = this;
return (((!((other57196 == null)))) && ((((this57195__$1.constructor === other57196.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57195__$1.tag,other57196.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57195__$1.prefix,other57196.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57195__$1.children,other57196.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57195__$1.__extmap,other57196.__extmap)))))))))));
}));
...
var self__ = this;
var _node__$1 = this;
var vec__57237 = rewrite_clj.node.protocols.sexprs.cljs$core$IFn$_invoke$arity$2(self__.children,opts);
var mta = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57237,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57237,(1),null);
...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k57192){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k57192);

}
}));

(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__57191){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__57256 = cljs.core.keyword_identical_QMARK_;
var expr__57257 = k__5352__auto__;
if(cljs.core.truth_((pred__57256.cljs$core$IFn$_invoke$arity$2 ? pred__57256.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__57257) : pred__57256.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__57257)))){
return (new rewrite_clj.node.meta.MetaNode(G__57191,self__.prefix,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__57256.cljs$core$IFn$_invoke$arity$2 ? pred__57256.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__57257) : pred__57256.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__57257)))){
return (new rewrite_clj.node.meta.MetaNode(self__.tag,G__57191,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__57256.cljs$core$IFn$_invoke$arity$2 ? pred__57256.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__57257) : pred__57256.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__57257)))){
return (new rewrite_clj.node.meta.MetaNode(self__.tag,self__.prefix,G__57191,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.meta.MetaNode(self__.tag,self__.prefix,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__57191),null));
}
}
}
}));
...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__57191){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.meta.MetaNode(self__.tag,self__.prefix,self__.children,G__57191,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.meta.map__GT_MetaNode = (function rewrite_clj$node$meta$map__GT_MetaNode(G__57203){
var extmap__5385__auto__ = (function (){var G__57266 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57203,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__57203)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__57266);
} else {
return G__57266;
}
})();
return (new rewrite_clj.node.meta.MetaNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__57203),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__57203),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__57203),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
