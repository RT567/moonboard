...
var rewrite_clj$node$protocols$Node$tag$dyn_55266 = (function (node){
...
return rewrite_clj$node$protocols$Node$tag$dyn_55266(node);
}
});

var rewrite_clj$node$protocols$Node$node_type$dyn_55270 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$node_type$dyn_55270(node);
}
});

var rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_55271 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_55271(node);
}
});

var rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_55272 = (function (node,opts){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_55272(node,opts);
}
});

var rewrite_clj$node$protocols$Node$length$dyn_55273 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$length$dyn_55273(node);
}
});

var rewrite_clj$node$protocols$Node$string$dyn_55278 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$string$dyn_55278(node);
}
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55223_SHARP_){
return rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(p1__55223_SHARP_,opts);
...
var rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_55288 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_55288(node);
}
});

var rewrite_clj$node$protocols$InnerNode$children$dyn_55292 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$children$dyn_55292(node);
}
});

var rewrite_clj$node$protocols$InnerNode$replace_children$dyn_55295 = (function (node,children){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$replace_children$dyn_55295(node,children);
}
});

var rewrite_clj$node$protocols$InnerNode$leader_length$dyn_55302 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$leader_length$dyn_55302(node);
}
});
...
var rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_55308 = (function (form){
...
return rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_55308(form);
}
});
...
var rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_55309 = (function (node,map_qualifier){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_55309(node,map_qualifier);
}
});

var rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_55312 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_55312(node);
}
});
...
var map__55254 = cljs.core.meta(node);
var map__55254__$1 = cljs.core.__destructure_map(map__55254);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55254__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55254__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var next_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55254__$1,new cljs.core.Keyword(null,"next-row","next-row",-408963777));
var next_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55254__$1,new cljs.core.Keyword(null,"next-col","next-col",601697889));
...
rewrite_clj.node.protocols._PLUS_extent = (function rewrite_clj$node$protocols$_PLUS_extent(p__55256,p__55257){
var vec__55258 = p__55256;
var row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55258,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55258,(1),null);
var vec__55261 = p__55257;
var row_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55261,(0),null);
var col_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55261,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(row + row_extent),(function (){var G__55264 = col_extent;
if((row_extent === (0))){
return (G__55264 + col);
} else {
return G__55264;
...
if(cljs.core.truth_(rewrite_clj.node.protocols.inner_QMARK_(node))){
var G__55265 = rewrite_clj.node.protocols.children(node);
var G__55265__$1 = (((G__55265 == null))?null:cljs.core.first(G__55265));
if((G__55265__$1 == null)){
return null;
} else {
return cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.tag,rewrite_clj.node.protocols.sexpr)(G__55265__$1);
}
} else {
