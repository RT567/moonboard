...
var map__72471 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.app-db.subs","popup-menu","day8.re-frame-10x.panels.app-db.subs/popup-menu",-100095659)], null)));
var map__72471__$1 = cljs.core.__destructure_map(map__72471);
var vec__72472 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72471__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var left = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72472,(0),null);
var top = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72472,(1),null);
var showing_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72471__$1,new cljs.core.Keyword(null,"showing?","showing?",2094921488));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72471__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72471__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var data_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72471__$1,new cljs.core.Keyword(null,"data-path","data-path",674802181));
...
var G__72477_72505 = data_path;
if((G__72477_72505 == null)){
} else {
day8.re_frame_10x.fx.clipboard.copy_BANG_(G__72477_72505);
}
...
var G__72480_72508 = data;
var G__72480_72509__$1 = (((G__72480_72508 == null))?null:cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(G__72480_72508,cljs.core.drop.cljs$core$IFn$_invoke$arity$2(cljs.core.count(path),cljs.core.pop(data_path))));
if((G__72480_72509__$1 == null)){
} else {
day8.re_frame_10x.fx.clipboard.copy_BANG_(G__72480_72509__$1);
}
