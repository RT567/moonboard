...
var args__$1 = args.map((function (p1__63272_SHARP_){
return sci.impl.types.eval(p1__63272_SHARP_,ctx,bindings);
}));
...
return Reflect.construct(constructor$,args.map((function (p1__63288_SHARP_){
return sci.impl.types.eval(p1__63288_SHARP_,ctx,bindings);
})));
});
sci.impl.interop.invoke_static_method = (function sci$impl$interop$invoke_static_method(ctx,bindings,class$,method,args){
return Reflect.apply(method,class$,args.map((function (p1__63295_SHARP_){
return sci.impl.types.eval(p1__63295_SHARP_,ctx,bindings);
})));
});
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__63318 = temp__5802__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63318,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63318,(1),null);
