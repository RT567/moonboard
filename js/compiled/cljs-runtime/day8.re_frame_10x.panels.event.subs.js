...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","root","day8.re-frame-10x.panels.event.subs/root",-909264964),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p__72247,_){
var map__72249 = p__72247;
var map__72249__$1 = cljs.core.__destructure_map(map__72249);
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72249__$1,new cljs.core.Keyword(null,"code","code",1586293142));
return code;
})], 0));
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","trace-id-for-epoch","day8.re-frame-10x.panels.event.subs/trace-id-for-epoch",728519790),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","code-for-epoch","day8.re-frame-10x.panels.event.subs/code-for-epoch",1888261905)], null),(function (p__72278,_){
var map__72279 = p__72278;
var map__72279__$1 = cljs.core.__destructure_map(map__72279);
var trace_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72279__$1,new cljs.core.Keyword(null,"trace-id","trace-id",681947249));
return trace_id;
})], 0));
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","form-for-epoch","day8.re-frame-10x.panels.event.subs/form-for-epoch",-1506248120),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","code-for-epoch","day8.re-frame-10x.panels.event.subs/code-for-epoch",1888261905)], null),(function (p__72280,_){
var map__72281 = p__72280;
var map__72281__$1 = cljs.core.__destructure_map(map__72281);
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72281__$1,new cljs.core.Keyword(null,"form","form",-1624062471));
return form;
})], 0));
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","code-open?","day8.re-frame-10x.panels.event.subs/code-open?",1956666991),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","root","day8.re-frame-10x.panels.event.subs/root",-909264964)], null),(function (p__72283,_){
var map__72284 = p__72283;
var map__72284__$1 = cljs.core.__destructure_map(map__72284);
var code_open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72284__$1,new cljs.core.Keyword(null,"code-open?","code-open?",1228336744));
return code_open_QMARK_;
})], 0));
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","highlighted-form","day8.re-frame-10x.panels.event.subs/highlighted-form",1402683478),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","root","day8.re-frame-10x.panels.event.subs/root",-909264964)], null),(function (p__72289,_){
var map__72291 = p__72289;
var map__72291__$1 = cljs.core.__destructure_map(map__72291);
var highlighted_form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72291__$1,new cljs.core.Keyword(null,"highlighted-form","highlighted-form",-1255288753));
...
var G__72465 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,i_s);
var G__72466 = (i_s + (1));
var G__72467 = (i_s_SINGLEQUOTE_ + (1));
v = G__72465;
i_s = G__72466;
i_s_SINGLEQUOTE_ = G__72467;
continue;
} else {
var G__72468 = v;
var G__72469 = (i_s + (1));
var G__72470 = i_s_SINGLEQUOTE_;
v = G__72468;
i_s = G__72469;
i_s_SINGLEQUOTE_ = G__72470;
continue;
...
var vec__72335 = day8.re_frame_10x.panels.event.subs.collapse_whitespace_and_index(form_str);
var form_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72335,(0),null);
var reindex = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72335,(1),null);
...
var vec__72349 = result;
var vec__72352 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72349,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72352,(0),null);
var pre_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72352,(1),null);
var matched_form = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72352,(2),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72349,(1),null);
...
var start = (function (){var G__72356 = form_str__$1;
var G__72356__$1 = (((G__72356 == null))?null:clojure.string.index_of.cljs$core$IFn$_invoke$arity$2(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([search_str], 0)),G__72356));
if((G__72356__$1 == null)){
return null;
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(reindex,G__72356__$1);
}
})();
...
var end = (function (){var G__72362 = start;
var G__72362__$1 = (((G__72362 == null))?null:(length + G__72362));
if((G__72362__$1 == null)){
return null;
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(reindex,G__72362__$1);
}
})();
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","highlighted-form-bounds","day8.re-frame-10x.panels.event.subs/highlighted-form-bounds",-992076813),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","highlighted-form","day8.re-frame-10x.panels.event.subs/highlighted-form",1402683478)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","zprint-form-for-epoch","day8.re-frame-10x.panels.event.subs/zprint-form-for-epoch",279472373)], null),(function (p__72374,_){
var vec__72376 = p__72374;
var highlighted_form = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72376,(0),null);
var form = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72376,(1),null);
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","highlighted?","day8.re-frame-10x.panels.event.subs/highlighted?",-173027178),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","zprint-form-for-epoch","day8.re-frame-10x.panels.event.subs/zprint-form-for-epoch",279472373)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","highlighted-form-bounds","day8.re-frame-10x.panels.event.subs/highlighted-form-bounds",-992076813)], null),(function (p__72383,p__72384){
var vec__72385 = p__72383;
var zp = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72385,(0),null);
var vec__72388 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72385,(1),null);
var left_bound = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72388,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72388,(1),null);
var vec__72391 = p__72384;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72391,(0),null);
var vec__72394 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72391,(1),null);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72394,(0),null);
var char$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72394,(1),null);
if((left_bound > (0))){
var line__$1 = (line - (1));
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","show-all-code?","day8.re-frame-10x.panels.event.subs/show-all-code?",1829719373),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","root","day8.re-frame-10x.panels.event.subs/root",-909264964)], null),(function (p__72406,_){
var map__72407 = p__72406;
var map__72407__$1 = cljs.core.__destructure_map(map__72407);
var show_all_code_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72407__$1,new cljs.core.Keyword(null,"show-all-code?","show-all-code?",159571286));
return show_all_code_QMARK_;
})], 0));
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","repl-msg-state","day8.re-frame-10x.panels.event.subs/repl-msg-state",1012951853),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","root","day8.re-frame-10x.panels.event.subs/root",-909264964)], null),(function (p__72410,_){
var map__72411 = p__72410;
var map__72411__$1 = cljs.core.__destructure_map(map__72411);
var repl_msg_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72411__$1,new cljs.core.Keyword(null,"repl-msg-state","repl-msg-state",-522274040));
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","max-column-width","day8.re-frame-10x.panels.event.subs/max-column-width",-1175866341),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.settings.subs","window-width-rounded","day8.re-frame-10x.panels.settings.subs/window-width-rounded",193095108),(100)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","single-character-width","day8.re-frame-10x.panels.event.subs/single-character-width",1463629101)], null),(function (p__72427,_){
var vec__72428 = p__72427;
var window_width = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72428,(0),null);
var char_width = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72428,(1),null);
