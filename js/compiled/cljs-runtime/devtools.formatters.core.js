...
}catch (e27848){var _e__16884__auto__ = e27848;
return false;
...
}catch (e27854){var _e__16884__auto__ = e27854;
return false;
...
}catch (e27866){var _e__16884__auto__ = e27866;
return false;
...
}catch (e27871){var _e__16884__auto__ = e27871;
return false;
...
}catch (e27874){var _e__16884__auto__ = e27874;
return false;
}})())){
...
}catch (e27876){var _e__16884__auto__ = e27876;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__27881 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__27882 = (function (){var or__5045__auto__ = config;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__27882);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__27881);
}});
});
...
return (function() { 
var G__27902__delegate = function (args){
...
while (G__27903__i < G__27903__a.length) {G__27903__a[G__27903__i] = arguments[G__27903__i + 0]; ++G__27903__i;}
  args = new cljs.core.IndexedSeq(G__27903__a,0,null);
} 
return G__27902__delegate.call(this,args);};
G__27902.cljs$lang$maxFixedArity = 0;
G__27902.cljs$lang$applyTo = (function (arglist__27904){
var args = cljs.core.seq(arglist__27904);
return G__27902__delegate(args);
});
