...
var G__26545 = devtools.prefs.pref(v);
v = G__26545;
continue;
} else {
return v;
...
}catch (e26479){var _e__16884__auto__ = e26479;
return false;
}})();
...
}catch (e26489){var _e__16884__auto__ = e26489;
return false;
}})();
...
}catch (e26491){var _e__16884__auto__ = e26491;
return false;
}}
}
});
...
var vec__26509 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26509,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26509,(1),null);
...
return cljs.core.some((function (p1__26518_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__26518_SHARP_);
}),template);
});
