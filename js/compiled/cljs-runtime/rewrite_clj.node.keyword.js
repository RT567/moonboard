...
rewrite_clj.node.keyword.keyword_sexpr = (function rewrite_clj$node$keyword$keyword_sexpr(kw,kw_auto_resolved_QMARK_,map_qualifier,p__55993){
var map__55994 = p__55993;
var map__55994__$1 = cljs.core.__destructure_map(map__55994);
var auto_resolve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55994__$1,new cljs.core.Keyword(null,"auto-resolve","auto-resolve",1851201983));
...
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var G__55995 = (cljs.core.truth_(new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351).cljs$core$IFn$_invoke$arity$1(q))?(function (){var G__55997 = (function (){var or__5045__auto__ = (function (){var G__55998 = new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(q);
if((G__55998 == null)){
return null;
} else {
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(G__55998);
}
})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
var fexpr__55996 = (function (){var or__5045__auto__ = auto_resolve;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
return (fexpr__55996.cljs$core$IFn$_invoke$arity$1 ? fexpr__55996.cljs$core$IFn$_invoke$arity$1(G__55997) : fexpr__55996.call(null,G__55997));
})():new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(q));
if((G__55995 == null)){
return null;
} else {
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__55995);
}
})(),cljs.core.name(kw));
});
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k56003,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k56003,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__56019){
var vec__56020 = p__56019;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56020,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56020,(1),null);
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this56004,other56005){
var self__ = this;
var this56004__$1 = this;
return (((!((other56005 == null)))) && ((((this56004__$1.constructor === other56005.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56004__$1.k,other56005.k)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56004__$1.auto_resolved_QMARK_,other56005.auto_resolved_QMARK_)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56004__$1.map_qualifier,other56005.map_qualifier)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56004__$1.__extmap,other56005.__extmap)))))))))));
}));
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k56003){
var self__ = this;
var this__5350__auto____$1 = this;
var G__56059 = k56003;
var G__56059__$1 = (((G__56059 instanceof cljs.core.Keyword))?G__56059.fqn:null);
switch (G__56059__$1) {
case "k":
case "auto-resolved?":
case "map-qualifier":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k56003);

}
}));

(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__56002){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__56063 = cljs.core.keyword_identical_QMARK_;
var expr__56064 = k__5352__auto__;
if(cljs.core.truth_((pred__56063.cljs$core$IFn$_invoke$arity$2 ? pred__56063.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"k","k",-2146297393),expr__56064) : pred__56063.call(null,new cljs.core.Keyword(null,"k","k",-2146297393),expr__56064)))){
return (new rewrite_clj.node.keyword.KeywordNode(G__56002,self__.auto_resolved_QMARK_,self__.map_qualifier,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56063.cljs$core$IFn$_invoke$arity$2 ? pred__56063.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351),expr__56064) : pred__56063.call(null,new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351),expr__56064)))){
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,G__56002,self__.map_qualifier,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56063.cljs$core$IFn$_invoke$arity$2 ? pred__56063.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"map-qualifier","map-qualifier",-1248117720),expr__56064) : pred__56063.call(null,new cljs.core.Keyword(null,"map-qualifier","map-qualifier",-1248117720),expr__56064)))){
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.auto_resolved_QMARK_,G__56002,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.auto_resolved_QMARK_,self__.map_qualifier,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__56002),null));
}
}
}
}));
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__56002){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.auto_resolved_QMARK_,self__.map_qualifier,G__56002,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.keyword.map__GT_KeywordNode = (function rewrite_clj$node$keyword$map__GT_KeywordNode(G__56010){
var extmap__5385__auto__ = (function (){var G__56081 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__56010,new cljs.core.Keyword(null,"k","k",-2146297393),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351),new cljs.core.Keyword(null,"map-qualifier","map-qualifier",-1248117720)], 0));
if(cljs.core.record_QMARK_(G__56010)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__56081);
} else {
return G__56081;
}
})();
return (new rewrite_clj.node.keyword.KeywordNode(new cljs.core.Keyword(null,"k","k",-2146297393).cljs$core$IFn$_invoke$arity$1(G__56010),new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351).cljs$core$IFn$_invoke$arity$1(G__56010),new cljs.core.Keyword(null,"map-qualifier","map-qualifier",-1248117720).cljs$core$IFn$_invoke$arity$1(G__56010),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
