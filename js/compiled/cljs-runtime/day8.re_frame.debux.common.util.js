...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__79464){
var vec__79465 = p__79464;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79465,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79465,(1),null);
...
return clojure.zip.zipper((function (p1__79468_SHARP_){
return ((cljs.core.sequential_QMARK_(p1__79468_SHARP_)) || (cljs.core.map_QMARK_(p1__79468_SHARP_)));
}),(function (x){
...
if(cljs.core.map_QMARK_(x)){
return cljs.core.with_meta(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__79476){
var vec__79477 = p__79476;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79477,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79477,(1),null);
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__79486_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__79486_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__79485_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__79485_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__79487_SHARP_){
return (((p1__79487_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__79487_SHARP_) == null)));
 ...
 */
day8.re_frame.debux.common.util.with_symbols_names = (function day8$re_frame$debux$common$util$with_symbols_names(form,p__79502,mapping){
var map__79503 = p__79502;
var map__79503__$1 = cljs.core.__destructure_map(map__79503);
var state = map__79503__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__79503__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__79503__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__79503__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__79499_SHARP_){
var and__5043__auto__ = (p1__79499_SHARP_ instanceof cljs.core.Symbol);
if(and__5043__auto__){
return cljs.core.namespace(p1__79499_SHARP_);
} else {
...
var G__79749 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__79750 = clojure.zip.next(loc);
loc = G__79750;
continue;
}
}
...
var len__5769__auto___79782 = arguments.length;
var i__5770__auto___79783 = (0);
while(true){
if((i__5770__auto___79783 < len__5769__auto___79782)){
args__5775__auto__.push((arguments[i__5770__auto___79783]));

var G__79785 = (i__5770__auto___79783 + (1));
i__5770__auto___79783 = G__79785;
continue;
} else {
}
break;
...
(day8.re_frame.debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__79555){
var vec__79559 = p__79555;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79559,(0),null);
...
/** @this {Function} */
(day8.re_frame.debux.common.util.form_header.cljs$lang$applyTo = (function (seq79548){
var G__79552 = cljs.core.first(seq79548);
var seq79548__$1 = cljs.core.next(seq79548);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__79552,seq79548__$1);
}));

day8.re_frame.debux.common.util.prepend_blanks = (function day8$re_frame$debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__79571_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__79571_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__79579_79793 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__79580_79794 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__79581_79795 = true;
var _STAR_print_fn_STAR__temp_val__79582_79796 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__79581_79795);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__79582_79796);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__79580_79794);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__79579_79793);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5690__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__79576_SHARP_){
return day8.re_frame.debux.common.util.prepend_bars(p1__79576_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__79815 = cljs.core.next(opts__$1);
var G__79816 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__79815;
acc = G__79816;
continue;
} else {
if(typeof f === 'string'){
var G__79817 = cljs.core.next(opts__$1);
var G__79818 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__79817;
acc = G__79818;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__79823 = cljs.core.nnext(opts__$1);
var G__79824 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__79823;
acc = G__79824;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__79829 = cljs.core.next(opts__$1);
var G__79830 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__79829;
acc = G__79830;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__79611 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__79611.cljs$core$IFn$_invoke$arity$1 ? fexpr__79611.cljs$core$IFn$_invoke$arity$1(f) : fexpr__79611.call(null,f));
})())){
var G__79837 = cljs.core.next(opts__$1);
var G__79838 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__79837;
acc = G__79838;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__79612 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__79612.cljs$core$IFn$_invoke$arity$1 ? fexpr__79612.cljs$core$IFn$_invoke$arity$1(f) : fexpr__79612.call(null,f));
})())){
var G__79840 = cljs.core.nnext(opts__$1);
var G__79841 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__79840;
acc = G__79841;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__79845 = cljs.core.next(opts__$1);
var G__79846 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__79845;
acc = G__79846;
continue;
} else {
...
day8.re_frame.debux.common.util.quote_val = (function day8$re_frame$debux$common$util$quote_val(p__79629){
var vec__79631 = p__79629;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79631,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79631,(1),null);
...
var G__79648 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__79647 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__79647.cljs$core$IFn$_invoke$arity$1 ? fexpr__79647.cljs$core$IFn$_invoke$arity$1(G__79648) : fexpr__79647.call(null,G__79648));
});
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__79669 = quoted_form;
var G__79670 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__79669,G__79670) : day8.re_frame.debux.common.util.remove_d.call(null,G__79669,G__79670));
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__79684 = quoted_form;
var G__79685 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__79684,G__79685) : day8.re_frame.debux.common.util.remove_d.call(null,G__79684,G__79685));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__79885__delegate = function (arg){
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__79709 = quoted_form;
var G__79710 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__79709,G__79710) : day8.re_frame.debux.common.util.remove_d.call(null,G__79709,G__79710));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__79885 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__79892__i = 0, G__79892__a = new Array(arguments.length -  0);
while (G__79892__i < G__79892__a.length) {G__79892__a[G__79892__i] = arguments[G__79892__i + 0]; ++G__79892__i;}
  arg = new cljs.core.IndexedSeq(G__79892__a,0,null);
} 
return G__79885__delegate.call(this,arg);};
G__79885.cljs$lang$maxFixedArity = 0;
G__79885.cljs$lang$applyTo = (function (arglist__79896){
var arg = cljs.core.seq(arglist__79896);
return G__79885__delegate(arg);
});
G__79885.cljs$core$IFn$_invoke$arity$variadic = G__79885__delegate;
return G__79885;
})()
;
});
...
var G__79924 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__79924;
continue;
} else {
...
var G__79930 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__79930;
continue;
} else {
var G__79932 = clojure.zip.next(loc);
loc = G__79932;
continue;
