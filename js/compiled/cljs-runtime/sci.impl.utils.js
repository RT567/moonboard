...
var map__63166 = cljs.core.meta(iobj);
var map__63166__$1 = cljs.core.__destructure_map(map__63166);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63166__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63166__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__63166__$1,new cljs.core.Keyword(null,"file","file",-1269645878),cljs.core.deref(sci.impl.utils.current_file));
...
var map__63187 = (function (){var or__5045__auto__ = stack;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
var G__63188 = env;
var G__63188__$1 = (((G__63188 == null))?null:cljs.core.deref(G__63188));
var G__63188__$2 = (((G__63188__$1 == null))?null:new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557).cljs$core$IFn$_invoke$arity$1(G__63188__$1));
var G__63188__$3 = (((G__63188__$2 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__63188__$2,id));
var G__63188__$4 = (((G__63188__$3 == null))?null:cljs.core.deref(G__63188__$3));
var G__63188__$5 = (((G__63188__$4 == null))?null:cljs.core.last(G__63188__$4));
if((G__63188__$5 == null)){
return null;
} else {
return cljs.core.meta(G__63188__$5);
}
}
})();
var map__63187__$1 = cljs.core.__destructure_map(map__63187);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63187__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63187__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63187__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
var new_exception = (function (){var new_d = (function (){var G__63195 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("sci","error","sci/error",-979082803),new cljs.core.Keyword(null,"line","line",212345235),line,new cljs.core.Keyword(null,"column","column",2078222095),column,new cljs.core.Keyword(null,"message","message",-406056002),ex_msg__$1,new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557),st,new cljs.core.Keyword(null,"file","file",-1269645878),file], null);
if(cljs.core.truth_(phase)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__63195,new cljs.core.Keyword(null,"phase","phase",575722892),phase);
} else {
return G__63195;
}
})();
...
var len__5769__auto___63285 = arguments.length;
var i__5770__auto___63286 = (0);
while(true){
if((i__5770__auto___63286 < len__5769__auto___63285)){
args__5775__auto__.push((arguments[i__5770__auto___63286]));

var G__63287 = (i__5770__auto___63286 + (1));
i__5770__auto___63286 = G__63287;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.utils.vary_meta_STAR_.cljs$lang$applyTo = (function (seq63204){
var G__63205 = cljs.core.first(seq63204);
var seq63204__$1 = cljs.core.next(seq63204);
var G__63206 = cljs.core.first(seq63204__$1);
var seq63204__$2 = cljs.core.next(seq63204__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__63205,G__63206,seq63204__$2);
}));

sci.impl.utils.strip_core_ns = (function sci$impl$utils$strip_core_ns(sym){
var G__63212 = cljs.core.namespace(sym);
switch (G__63212) {
case "clojure.core":
case "cljs.core":
...
var fexpr__63230 = cljs.core.deref(sci.impl.utils.eval_form_state);
return (fexpr__63230.cljs$core$IFn$_invoke$arity$2 ? fexpr__63230.cljs$core$IFn$_invoke$arity$2(sci_ctx,form) : fexpr__63230.call(null,sci_ctx,form));
});
/**
...
return cljs.core.cons(run,(function (){var G__63234 = pred;
var G__63235 = (new cljs.core.LazySeq(null,(function (){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2(cljs.core.count(run),s);
}),null,null));
return (sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2 ? sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2(G__63234,G__63235) : sci.impl.utils.split_when.call(null,G__63234,G__63235));
})());
} else {
return null;
}
...
var G__63306 = cljs.core.next(params__$1);
var G__63307 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,cljs.core.first(params__$1));
var G__63308 = lets;
params__$1 = G__63306;
new_params = G__63307;
lets = G__63308;
...
var G__63310 = cljs.core.next(params__$1);
var G__63311 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,gparam);
var G__63312 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(lets,cljs.core.first(params__$1)),gparam);
params__$1 = G__63310;
new_params = G__63311;
lets = G__63312;
continue;
...
var G__63248 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(expr_meta,new cljs.core.Keyword(null,"ns","ns",441598760),cljs.core.deref(sci.impl.utils.current_ns),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"file","file",-1269645878),cljs.core.deref(sci.impl.utils.current_file)], 0));
if(cljs.core.truth_(special_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__63248,new cljs.core.Keyword(null,"special","special",-1125941630),true);
} else {
return G__63248;
}
}));
...
var args__5775__auto__ = [];
var len__5769__auto___63315 = arguments.length;
var i__5770__auto___63316 = (0);
while(true){
if((i__5770__auto___63316 < len__5769__auto___63315)){
args__5775__auto__.push((arguments[i__5770__auto___63316]));

var G__63317 = (i__5770__auto___63316 + (1));
i__5770__auto___63316 = G__63317;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.utils.log.cljs$lang$applyTo = (function (seq63250){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq63250));
}));
...
var G__63268 = sci.impl.utils.new_var.cljs$core$IFn$_invoke$arity$4(name,null,null,false);
sci.impl.vars.unbind(G__63268);
