...
var len__5769__auto___80389 = arguments.length;
var i__5770__auto___80390 = (0);
while(true){
if((i__5770__auto___80390 < len__5769__auto___80389)){
args__5775__auto__.push((arguments[i__5770__auto___80390]));

var G__80392 = (i__5770__auto___80390 + (1));
i__5770__auto___80390 = G__80392;
continue;
} else {
}
break;
...
return re_com.text.label.cljs$core$IFn$_invoke$arity$variadic(argseq__5776__auto__);
});

(re_com.text.label.cljs$core$IFn$_invoke$arity$variadic = (function (p__80294){
var map__80295 = p__80294;
var map__80295__$1 = cljs.core.__destructure_map(map__80295);
var args = map__80295__$1;
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80295__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var parts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80295__$1,new cljs.core.Keyword(null,"parts","parts",849007691));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80295__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var src = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80295__$1,new cljs.core.Keyword(null,"src","src",-1651076051));
var on_click = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80295__$1,new cljs.core.Keyword(null,"on-click","on-click",1632826543));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80295__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var debug_as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80295__$1,new cljs.core.Keyword(null,"debug-as","debug-as",283322354));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80295__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80295__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var or__5045__auto__ = (((!(goog.DEBUG)))?null:re_com.validate.validate_args(re_com.validate.extract_arg_data(re_com.text.label_args_desc),args));
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return new cljs.core.PersistentVector(null, 17, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.box,new cljs.core.Keyword(null,"debug-as","debug-as",283322354),(function (){var or__5045__auto____$1 = debug_as;
...
/** @this {Function} */
(re_com.text.label.cljs$lang$applyTo = (function (seq80287){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq80287));
}));
...
var args__5775__auto__ = [];
var len__5769__auto___80420 = arguments.length;
var i__5770__auto___80421 = (0);
while(true){
if((i__5770__auto___80421 < len__5769__auto___80420)){
args__5775__auto__.push((arguments[i__5770__auto___80421]));

var G__80424 = (i__5770__auto___80421 + (1));
i__5770__auto___80421 = G__80424;
continue;
} else {
}
break;
...
var argseq__5776__auto__ = ((((0) < args__5775__auto__.length))?(new cljs.core.IndexedSeq(args__5775__auto__.slice((0)),(0),null)):null);
return re_com.text.title.cljs$core$IFn$_invoke$arity$variadic(argseq__5776__auto__);
});

(re_com.text.title.cljs$core$IFn$_invoke$arity$variadic = (function (p__80331){
var map__80335 = p__80331;
var map__80335__$1 = cljs.core.__destructure_map(map__80335);
var args = map__80335__$1;
var margin_bottom = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__80335__$1,new cljs.core.Keyword(null,"margin-bottom","margin-bottom",388334941),"0.3em");
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80335__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var margin_top = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__80335__$1,new cljs.core.Keyword(null,"margin-top","margin-top",392161226),"0.6em");
var parts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80335__$1,new cljs.core.Keyword(null,"parts","parts",849007691));
var underline_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80335__$1,new cljs.core.Keyword(null,"underline?","underline?",-1123247603));
var src = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80335__$1,new cljs.core.Keyword(null,"src","src",-1651076051));
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80335__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80335__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var debug_as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80335__$1,new cljs.core.Keyword(null,"debug-as","debug-as",283322354));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80335__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80335__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var or__5045__auto__ = (((!(goog.DEBUG)))?null:re_com.validate.validate_args(re_com.validate.extract_arg_data(re_com.text.title_args_desc),args));
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
var preset_class = (((level == null))?"":cljs.core.name(level));
return new cljs.core.PersistentVector(null, 13, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.v_box,new cljs.core.Keyword(null,"src","src",-1651076051),src,new cljs.core.Keyword(null,"debug-as","debug-as",283322354),(function (){var or__5045__auto____$1 = debug_as;
if(cljs.core.truth_(or__5045__auto____$1)){
return or__5045__auto____$1;
} else {
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"component","component",1555936782),re_com.debug.short_component_name(reagent.impl.component.component_name(reagent.core.current_component())),new cljs.core.Keyword(null,"args","args",1315556576),args], null);
...
/** @this {Function} */
(re_com.text.title.cljs$lang$applyTo = (function (seq80321){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq80321));
}));
...
var args__5775__auto__ = [];
var len__5769__auto___80447 = arguments.length;
var i__5770__auto___80448 = (0);
while(true){
if((i__5770__auto___80448 < len__5769__auto___80447)){
args__5775__auto__.push((arguments[i__5770__auto___80448]));

var G__80453 = (i__5770__auto___80448 + (1));
i__5770__auto___80448 = G__80453;
continue;
} else {
}
break;
...
var argseq__5776__auto__ = ((((0) < args__5775__auto__.length))?(new cljs.core.IndexedSeq(args__5775__auto__.slice((0)),(0),null)):null);
return re_com.text.p.cljs$core$IFn$_invoke$arity$variadic(argseq__5776__auto__);
});

(re_com.text.p.cljs$core$IFn$_invoke$arity$variadic = (function (children){
var child1 = cljs.core.first(children);
var vec__80352 = ((cljs.core.map_QMARK_(child1))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [child1,cljs.core.rest(children)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.PersistentArrayMap.EMPTY,children], null));
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80352,(0),null);
var children__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80352,(1),null);
...
/** @this {Function} */
(re_com.text.p.cljs$lang$applyTo = (function (seq80341){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq80341));
}));
