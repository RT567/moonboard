...
return rewrite_clj.node.protocols.coerce((function (){var G__59050 = rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(node,opts);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__59050) : f.call(null,G__59050));
})());
});
});
/**
...
args__5775__auto__.push((arguments[i__5770__auto___59119]));
...
return rewrite_clj.custom_zipper.core.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.node_editor(rewrite_clj.zip.options.get_opts(zloc)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__59053_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__59053_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq59054){
var G__59055 = cljs.core.first(seq59054);
var seq59054__$1 = cljs.core.next(seq59054);
var G__59057 = cljs.core.first(seq59054__$1);
var seq59054__$2 = cljs.core.next(seq59054__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__59055,G__59057,seq59054__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__59081 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__59081) : str_fn.call(null,G__59081));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__59085 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__59085) : str_fn.call(null,G__59085));
})()):null)));
...
var G__59098 = rewrite_clj.zip.base.tag(zloc);
var G__59098__$1 = (((G__59098 instanceof cljs.core.Keyword))?G__59098.fqn:null);
switch (G__59098__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__59094_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__59094_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__59095_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__59095_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__59098__$1)].join('')));
...
var G__59111 = rewrite_clj.zip.base.tag(zloc);
var G__59111__$1 = (((G__59111 instanceof cljs.core.Keyword))?G__59111.fqn:null);
switch (G__59111__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__59108_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__59108_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__59111__$1)].join('')));
