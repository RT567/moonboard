...
var zloc_seq_nc = (function (){var G__62700 = cljs.core.identity;
var G__62701 = new cljs.core.Keyword(null,"zloc","zloc",-2123059767).cljs$core$IFn$_invoke$arity$1(opts);
var fexpr__62699 = new cljs.core.Keyword(null,"zmap-no-comment","zmap-no-comment",1484161325).cljs$core$IFn$_invoke$arity$1(zfn_map);
return (fexpr__62699.cljs$core$IFn$_invoke$arity$2 ? fexpr__62699.cljs$core$IFn$_invoke$arity$2(G__62700,G__62701) : fexpr__62699.call(null,G__62700,G__62701));
})();
var meta_zloc = cljs.core.second(zloc_seq_nc);
var meta_seq = (function (){var fexpr__62703 = new cljs.core.Keyword(null,"zmap-no-comment","zmap-no-comment",1484161325).cljs$core$IFn$_invoke$arity$1(zfn_map);
return (fexpr__62703.cljs$core$IFn$_invoke$arity$2 ? fexpr__62703.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,meta_zloc) : fexpr__62703.call(null,cljs.core.identity,meta_zloc));
})();
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"meta","meta",1499536964),(function (){var G__62707 = cljs.core.second(meta_seq);
var fexpr__62706 = new cljs.core.Keyword(null,"ztag","ztag",125694964).cljs$core$IFn$_invoke$arity$1(zfn_map);
return (fexpr__62706.cljs$core$IFn$_invoke$arity$1 ? fexpr__62706.cljs$core$IFn$_invoke$arity$1(G__62707) : fexpr__62706.call(null,G__62707));
})())){
return null;
} else {
...
var result = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__62740_SHARP_,p2__62739_SHARP_){
if(cljs.core.truth_(cljs.core.re_find(cljs.core.first(p2__62739_SHARP_),fn_str))){
return cljs.core.reduced(cljs.core.second(p2__62739_SHARP_));
} else {
return null;
}
}),null,rule_pairs);
...
var fn_str = cljs.core.str.cljs$core$IFn$_invoke$arity$1(fn_name);
var rule_pairs = cljs.core.partition.cljs$core$IFn$_invoke$arity$4((2),(2),cljs.core.repeat.cljs$core$IFn$_invoke$arity$1(null),rules_vec);
var result = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__62766_SHARP_,p2__62764_SHARP_){
var lhs = cljs.core.first(p2__62764_SHARP_);
...
return cljs.core.reduced(cljs.core.second(p2__62764_SHARP_));
} else {
return null;
}
} else {
if(cljs.core.truth_(cljs.core.re_find(cljs.core.first(p2__62764_SHARP_),fn_str))){
return cljs.core.reduced(cljs.core.second(p2__62764_SHARP_));
} else {
return null;
}
