...
var G__57306 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(nodes,n);
nodes = G__57306;
continue;
} else {
...
var vec__57303 = rewrite_clj.parser.namespaced_map.parse_to_next_elem(reader,read_next);
var whitespace_nodes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57303,(0),null);
var map_node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57303,(1),null);
