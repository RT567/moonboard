...
var react_major_version_73662 = cljs.core.first(clojure.string.split.cljs$core$IFn$_invoke$arity$2(module$node_modules$react$index.version,/\./));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("17",react_major_version_73662)){
} else {
console.warn("Re-frame-10x expects React 17, but React",react_major_version_73662,"is loaded. This causes deprecation warnings.",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("18",react_major_version_73662))?"To fix this, try declaring `day8.re-frame-10x.preload.react-18` in your shadow-cljs.edn (instead of `day8.re-frame-10x.preload`). See https://github.com/day8/re-frame-10x/#compatibility-matrix":null));
}
