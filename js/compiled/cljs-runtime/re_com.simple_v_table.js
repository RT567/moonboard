...
re_com.simple_v_table.swap_BANG__sort_by_column = (function re_com$simple_v_table$swap_BANG__sort_by_column(p__81891,new_key_fn,new_comp){
var map__81893 = p__81891;
var map__81893__$1 = cljs.core.__destructure_map(map__81893);
var key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81893__$1,new cljs.core.Keyword(null,"key-fn","key-fn",-636154479));
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81893__$1,new cljs.core.Keyword(null,"order","order",-1254677256));
...
re_com.simple_v_table.column_header_item = (function re_com$simple_v_table$column_header_item(p__81896,parts,sort_by_column){
var map__81897 = p__81896;
var map__81897__$1 = cljs.core.__destructure_map(map__81897);
var column = map__81897__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81897__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var row_label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81897__$1,new cljs.core.Keyword(null,"row-label-fn","row-label-fn",1457434308));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81897__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81897__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81897__$1,new cljs.core.Keyword(null,"align","align",1964212802));
var vertical_align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81897__$1,new cljs.core.Keyword(null,"vertical-align","vertical-align",651007333));
var header_label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81897__$1,new cljs.core.Keyword(null,"header-label","header-label",765876429));
var sort_by = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81897__$1,new cljs.core.Keyword(null,"sort-by","sort-by",-322599303));
var map__81898 = sort_by;
var map__81898__$1 = cljs.core.__destructure_map(map__81898);
var key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__81898__$1,new cljs.core.Keyword(null,"key-fn","key-fn",-636154479),row_label_fn);
var comp = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__81898__$1,new cljs.core.Keyword(null,"comp","comp",1191953630),cljs.core.compare);
var map__81899 = cljs.core.deref(sort_by_column);
var map__81899__$1 = cljs.core.__destructure_map(map__81899);
var current_key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81899__$1,new cljs.core.Keyword(null,"key-fn","key-fn",-636154479));
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81899__$1,new cljs.core.Keyword(null,"order","order",-1254677256));
...
return null;
})], null),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"simple-column-header","simple-column-header",-1241463404),new cljs.core.Keyword(null,"attr","attr",-604132353)], null))], 0))], null),(function (){var iter__5523__auto__ = (function re_com$simple_v_table$column_header_renderer_$_iter__81900(s__81901){
return (new cljs.core.LazySeq(null,(function (){
var s__81901__$1 = s__81901;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__81901__$1);
if(temp__5804__auto__){
var s__81901__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__81901__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__81901__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__81903 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__81902 = (0);
while(true){
if((i__81902 < size__5522__auto__)){
var column = cljs.core._nth(c__5521__auto__,i__81902);
cljs.core.chunk_append(b__81903,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.column_header_item,column,parts,sort_by_column], null));

var G__81989 = (i__81902 + (1));
i__81902 = G__81989;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__81903),re_com$simple_v_table$column_header_renderer_$_iter__81900(cljs.core.chunk_rest(s__81901__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__81903),null);
}
} else {
var column = cljs.core.first(s__81901__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.column_header_item,column,parts,sort_by_column], null),re_com$simple_v_table$column_header_renderer_$_iter__81900(cljs.core.rest(s__81901__$2)));
}
} else {
return null;
}
 ...
 */
re_com.simple_v_table.row_item = (function re_com$simple_v_table$row_item(row,p__81906,cell_style,parts){
var map__81907 = p__81906;
var map__81907__$1 = cljs.core.__destructure_map(map__81907);
var column = map__81907__$1;
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81907__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81907__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81907__$1,new cljs.core.Keyword(null,"align","align",1964212802));
var vertical_align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81907__$1,new cljs.core.Keyword(null,"vertical-align","vertical-align",651007333));
var row_label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81907__$1,new cljs.core.Keyword(null,"row-label-fn","row-label-fn",1457434308));
...
return null;
}):null)], null),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"simple-row","simple-row",-252554766),new cljs.core.Keyword(null,"attr","attr",-604132353)], null))], 0))], null),(function (){var iter__5523__auto__ = (function re_com$simple_v_table$row_renderer_$_iter__81908(s__81909){
return (new cljs.core.LazySeq(null,(function (){
var s__81909__$1 = s__81909;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__81909__$1);
if(temp__5804__auto__){
var s__81909__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__81909__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__81909__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__81911 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__81910 = (0);
while(true){
if((i__81910 < size__5522__auto__)){
var column = cljs.core._nth(c__5521__auto__,i__81910);
cljs.core.chunk_append(b__81911,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.row_item,row,column,cell_style,parts], null));

var G__81999 = (i__81910 + (1));
i__81910 = G__81999;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__81911),re_com$simple_v_table$row_renderer_$_iter__81908(cljs.core.chunk_rest(s__81909__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__81911),null);
}
} else {
var column = cljs.core.first(s__81909__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.row_item,row,column,cell_style,parts], null),re_com$simple_v_table$row_renderer_$_iter__81908(cljs.core.rest(s__81909__$2)));
}
} else {
return null;
}
...
re_com.simple_v_table.simple_v_table_parts_desc = ((re_com.config.include_args_desc_QMARK_)?cljs.core.into.cljs$core$IFn$_invoke$arity$2(re_com.simple_v_table.simple_v_table_exclusive_parts_desc,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__81915_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(p1__81915_SHARP_,new cljs.core.Keyword(null,"level","level",1290497552),cljs.core.inc);
...
var len__5769__auto___82020 = arguments.length;
var i__5770__auto___82021 = (0);
while(true){
if((i__5770__auto___82021 < len__5769__auto___82020)){
args__5775__auto__.push((arguments[i__5770__auto___82021]));

var G__82022 = (i__5770__auto___82021 + (1));
i__5770__auto___82021 = G__82022;
continue;
} else {
}
break;
...
(re_com.simple_v_table.simple_v_table.cljs$core$IFn$_invoke$arity$variadic = (function (p__81933){
var map__81934 = p__81933;
var map__81934__$1 = cljs.core.__destructure_map(map__81934);
var args = map__81934__$1;
var src = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81934__$1,new cljs.core.Keyword(null,"src","src",-1651076051));
...
return (function() { 
var re_com$simple_v_table$simple_v_table_render__delegate = function (p__81935){
var map__81936 = p__81935;
var map__81936__$1 = cljs.core.__destructure_map(map__81936);
var args__$1 = map__81936__$1;
var cell_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81936__$1,new cljs.core.Keyword(null,"cell-style","cell-style",1087536089));
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81936__$1,new cljs.core.Keyword(null,"model","model",331153215));
var on_leave_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81936__$1,new cljs.core.Keyword(null,"on-leave-row","on-leave-row",1361264390));
var columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81936__$1,new cljs.core.Keyword(null,"columns","columns",1998437288));
var parts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81936__$1,new cljs.core.Keyword(null,"parts","parts",849007691));
var on_enter_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81936__$1,new cljs.core.Keyword(null,"on-enter-row","on-enter-row",-139996948));
var row_height = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__81936__$1,new cljs.core.Keyword(null,"row-height","row-height",527360749),(31));
var max_width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81936__$1,new cljs.core.Keyword(null,"max-width","max-width",-1939924051));
var src__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81936__$1,new cljs.core.Keyword(null,"src","src",-1651076051));
var on_click_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81936__$1,new cljs.core.Keyword(null,"on-click-row","on-click-row",-383826673));
var table_row_line_color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__81936__$1,new cljs.core.Keyword(null,"table-row-line-color","table-row-line-color",680569135),"#EAEEF1");
var table_padding = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__81936__$1,new cljs.core.Keyword(null,"table-padding","table-padding",-702873839),(19));
var column_header_height = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__81936__$1,new cljs.core.Keyword(null,"column-header-height","column-header-height",-1680092558),(31));
var debug_as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81936__$1,new cljs.core.Keyword(null,"debug-as","debug-as",283322354));
var max_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81936__$1,new cljs.core.Keyword(null,"max-rows","max-rows",-2131113613));
var row_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81936__$1,new cljs.core.Keyword(null,"row-style","row-style",1352472052));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81936__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var fixed_column_border_color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__81936__$1,new cljs.core.Keyword(null,"fixed-column-border-color","fixed-column-border-color",2036669142),"#BBBEC0");
var column_header_renderer = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__81936__$1,new cljs.core.Keyword(null,"column-header-renderer","column-header-renderer",-1886265578),re_com.simple_v_table.column_header_renderer);
var fixed_column_count = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__81936__$1,new cljs.core.Keyword(null,"fixed-column-count","fixed-column-count",721535030),(0));
...
var map__81937 = temp__5802__auto__;
var map__81937__$1 = cljs.core.__destructure_map(map__81937);
var key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81937__$1,new cljs.core.Keyword(null,"key-fn","key-fn",-636154479));
var comp = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__81937__$1,new cljs.core.Keyword(null,"comp","comp",1191953630),cljs.core.compare);
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81937__$1,new cljs.core.Keyword(null,"order","order",-1254677256));
...
var G__82035__i = 0, G__82035__a = new Array(arguments.length -  0);
while (G__82035__i < G__82035__a.length) {G__82035__a[G__82035__i] = arguments[G__82035__i + 0]; ++G__82035__i;}
  p__81935 = new cljs.core.IndexedSeq(G__82035__a,0,null);
} 
return re_com$simple_v_table$simple_v_table_render__delegate.call(this,p__81935);};
re_com$simple_v_table$simple_v_table_render.cljs$lang$maxFixedArity = 0;
re_com$simple_v_table$simple_v_table_render.cljs$lang$applyTo = (function (arglist__82036){
var p__81935 = cljs.core.seq(arglist__82036);
return re_com$simple_v_table$simple_v_table_render__delegate(p__81935);
});
...
/** @this {Function} */
(re_com.simple_v_table.simple_v_table.cljs$lang$applyTo = (function (seq81930){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq81930));
}));
