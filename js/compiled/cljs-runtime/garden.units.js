 ...
 */
garden.units.convert = (function garden$units$convert(p__81985,right){
var map__81986 = p__81985;
var map__81986__$1 = cljs.core.__destructure_map(map__81986);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81986__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__81986__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__81996 = temp__5804__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81996,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81996,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81996,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82006__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__82007 = u(y);
var map__82007__$1 = cljs.core.__destructure_map(map__82007);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82007__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__82112__delegate = function (x,y,more){
...
var G__82112 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__82113__i = 0, G__82113__a = new Array(arguments.length -  2);
while (G__82113__i < G__82113__a.length) {G__82113__a[G__82113__i] = arguments[G__82113__i + 2]; ++G__82113__i;}
  more = new cljs.core.IndexedSeq(G__82113__a,0,null);
} 
return G__82112__delegate.call(this,x,y,more);};
G__82112.cljs$lang$maxFixedArity = 2;
G__82112.cljs$lang$applyTo = (function (arglist__82114){
var x = cljs.core.first(arglist__82114);
arglist__82114 = cljs.core.next(arglist__82114);
var y = cljs.core.first(arglist__82114);
var more = cljs.core.rest(arglist__82114);
return G__82112__delegate(x,y,more);
});
...
var G__82115 = null;
if (arguments.length > 2) {
var G__82116__i = 0, G__82116__a = new Array(arguments.length -  2);
while (G__82116__i < G__82116__a.length) {G__82116__a[G__82116__i] = arguments[G__82116__i + 2]; ++G__82116__i;}
G__82115 = new cljs.core.IndexedSeq(G__82116__a,0,null);
}
return garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__82115);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82015__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__82016 = u(y);
var map__82016__$1 = cljs.core.__destructure_map(map__82016);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82016__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
var garden$units$make_unit_subtractor_$_u___3 = (function() { 
var G__82117__delegate = function (x,y,more){
...
var G__82117 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__82118__i = 0, G__82118__a = new Array(arguments.length -  2);
while (G__82118__i < G__82118__a.length) {G__82118__a[G__82118__i] = arguments[G__82118__i + 2]; ++G__82118__i;}
  more = new cljs.core.IndexedSeq(G__82118__a,0,null);
} 
return G__82117__delegate.call(this,x,y,more);};
G__82117.cljs$lang$maxFixedArity = 2;
G__82117.cljs$lang$applyTo = (function (arglist__82119){
var x = cljs.core.first(arglist__82119);
arglist__82119 = cljs.core.next(arglist__82119);
var y = cljs.core.first(arglist__82119);
var more = cljs.core.rest(arglist__82119);
return G__82117__delegate(x,y,more);
});
G__82117.cljs$core$IFn$_invoke$arity$variadic = G__82117__delegate;
return G__82117;
})()
;
...
var G__82120 = null;
if (arguments.length > 2) {
var G__82121__i = 0, G__82121__a = new Array(arguments.length -  2);
while (G__82121__i < G__82121__a.length) {G__82121__a[G__82121__i] = arguments[G__82121__i + 2]; ++G__82121__i;}
G__82120 = new cljs.core.IndexedSeq(G__82121__a,0,null);
}
return garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__82120);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var map__82018 = u(x);
var map__82018__$1 = cljs.core.__destructure_map(map__82018);
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82018__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__82019 = u(y);
var map__82019__$1 = cljs.core.__destructure_map(map__82019);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82019__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var G__82122__delegate = function (x,y,more){
...
var G__82122 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__82126__i = 0, G__82126__a = new Array(arguments.length -  2);
while (G__82126__i < G__82126__a.length) {G__82126__a[G__82126__i] = arguments[G__82126__i + 2]; ++G__82126__i;}
  more = new cljs.core.IndexedSeq(G__82126__a,0,null);
} 
return G__82122__delegate.call(this,x,y,more);};
G__82122.cljs$lang$maxFixedArity = 2;
G__82122.cljs$lang$applyTo = (function (arglist__82127){
var x = cljs.core.first(arglist__82127);
arglist__82127 = cljs.core.next(arglist__82127);
var y = cljs.core.first(arglist__82127);
var more = cljs.core.rest(arglist__82127);
return G__82122__delegate(x,y,more);
});
G__82122.cljs$core$IFn$_invoke$arity$variadic = G__82122__delegate;
return G__82122;
})()
;
...
var G__82128 = null;
if (arguments.length > 2) {
var G__82129__i = 0, G__82129__a = new Array(arguments.length -  2);
while (G__82129__i < G__82129__a.length) {G__82129__a[G__82129__i] = arguments[G__82129__i + 2]; ++G__82129__i;}
G__82128 = new cljs.core.IndexedSeq(G__82129__a,0,null);
}
return garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__82128);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82023__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__82024 = u(y);
var map__82024__$1 = cljs.core.__destructure_map(map__82024);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82024__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
var garden$units$make_unit_divider_$_ud__3 = (function() { 
var G__82130__delegate = function (x,y,more){
...
var G__82130 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__82131__i = 0, G__82131__a = new Array(arguments.length -  2);
while (G__82131__i < G__82131__a.length) {G__82131__a[G__82131__i] = arguments[G__82131__i + 2]; ++G__82131__i;}
  more = new cljs.core.IndexedSeq(G__82131__a,0,null);
} 
return G__82130__delegate.call(this,x,y,more);};
G__82130.cljs$lang$maxFixedArity = 2;
G__82130.cljs$lang$applyTo = (function (arglist__82132){
var x = cljs.core.first(arglist__82132);
arglist__82132 = cljs.core.next(arglist__82132);
var y = cljs.core.first(arglist__82132);
var more = cljs.core.rest(arglist__82132);
return G__82130__delegate(x,y,more);
});
...
var G__82134 = null;
if (arguments.length > 2) {
var G__82135__i = 0, G__82135__a = new Array(arguments.length -  2);
while (G__82135__i < G__82135__a.length) {G__82135__a[G__82135__i] = arguments[G__82135__i + 2]; ++G__82135__i;}
G__82134 = new cljs.core.IndexedSeq(G__82135__a,0,null);
}
return garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__82134);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
