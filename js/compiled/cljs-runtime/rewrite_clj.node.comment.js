...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k55275,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k55275,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__55297){
var vec__55298 = p__55297;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55298,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55298,(1),null);
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this55276,other55277){
var self__ = this;
var this55276__$1 = this;
return (((!((other55277 == null)))) && ((((this55276__$1.constructor === other55277.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this55276__$1.prefix,other55277.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this55276__$1.s,other55277.s)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this55276__$1.__extmap,other55277.__extmap)))))))));
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k55275){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k55275);

}
}));

(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__55274){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__55323 = cljs.core.keyword_identical_QMARK_;
var expr__55324 = k__5352__auto__;
if(cljs.core.truth_((pred__55323.cljs$core$IFn$_invoke$arity$2 ? pred__55323.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__55324) : pred__55323.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__55324)))){
return (new rewrite_clj.node.comment.CommentNode(G__55274,self__.s,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__55323.cljs$core$IFn$_invoke$arity$2 ? pred__55323.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"s","s",1705939918),expr__55324) : pred__55323.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__55324)))){
return (new rewrite_clj.node.comment.CommentNode(self__.prefix,G__55274,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.comment.CommentNode(self__.prefix,self__.s,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__55274),null));
}
}
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__55274){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.comment.CommentNode(self__.prefix,self__.s,G__55274,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.comment.map__GT_CommentNode = (function rewrite_clj$node$comment$map__GT_CommentNode(G__55279){
var extmap__5385__auto__ = (function (){var G__55337 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__55279,new cljs.core.Keyword(null,"prefix","prefix",-265908465),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"s","s",1705939918)], 0));
if(cljs.core.record_QMARK_(G__55279)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__55337);
} else {
return G__55337;
}
})();
return (new rewrite_clj.node.comment.CommentNode(new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__55279),new cljs.core.Keyword(null,"s","s",1705939918).cljs$core$IFn$_invoke$arity$1(G__55279),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
